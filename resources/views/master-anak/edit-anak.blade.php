                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" class="form-control" id="umur"
                                                value="{{ $anak->umur }}" name="umur">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="jk" name="jk" required>
                                                ...
                                                <option value="Perempuan"
                                                    {{ $anak->jk == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="ibu_bekerja" name="ibu_bekerja" required>
                                                ...
                                                <option value="Ya" {{ $anak->ibu_bekerja == 'Ya' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="Tidak"
                                                    {{ $anak->ibu_bekerja == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="pendidikan_ayah" name="pendidikan_ayah"
                                                ...
                                                <option value="Tidak Bersekolah"
                                                    ...
                                                    Tidak Bersekolah</option>
                                                <option value="SD"
                                                    {{ $anak->pendidikan_ayah == 'SD' ? 'selected' : '' }}>SD</option>
                                                <option value="SMP"
                                                    {{ $anak->pendidikan_ayah == 'SMP' ? 'selected' : '' }}>SMP</option>
                                                <option value="SMA"
                                                    {{ $anak->pendidikan_ayah == 'SMA' ? 'selected' : '' }}>SMA</option>
                                                <option value="S1"
                                                    {{ $anak->pendidikan_ayah == 'S1' ? 'selected' : '' }}>S1</option>
                                                <option value="S2"
