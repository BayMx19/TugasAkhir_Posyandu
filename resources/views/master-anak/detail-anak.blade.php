                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tgl_lahir" onchange="calculateAge()"
                                            name="tgl_lahir" value="{{ $anak->tgl_lahir }}" required disabled>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6 ">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tgl_lahir_ibu" name="tgl_lahir_ibu"
                                            onchange="calculateAgeIbu()" required disabled
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pendidikan_ibu"
                                            name="pendidikan_ibu" readonly disabled value="{{ $anak->pendidikan_ibu }}">
                                ...
                                <div class="col-sm-6 ">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="umurDisplay_ayah" name="umur_ayah"
                                            readonly disabled value="{{ $anak->umur_ayah }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <option value="SMP" {{ $anak->pendidikan_ayah == 'SMP' ? 'selected' : '' }}>SMP
                                        </option>
                                        <option value="SMA" {{ $anak->pendidikan_ayah == 'SMA' ? 'selected' : '' }}>SMA
                                        </option>
                                        <option value="S1" {{ $anak->pendidikan_ayah == 'S1' ? 'selected' : '' }}>S1
                                        </option>
                                        <option value="S2" {{ $anak->pendidikan_ayah == 'S2' ? 'selected' : '' }}>S2
                                        </option>
                                        <option value="S3" {{ $anak->pendidikan_ayah == 'S2' ? 'selected' : '' }}>S3
                                        </option>
                                        </select> --}}
